...
class MockCompatLayer : public CompatibilityLayerInterface {
 public:
  ...
  MOCK_METHOD(void, init, (std::string file_path, std::unique_ptr<utilities::UtilitiesInterface> utilities, std::unique_ptr<filereader::FileReaderInterface> file_reader), (override));
