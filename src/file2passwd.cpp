...
std::streamsize file2passwd::get_file_size(void)
{
	std::ifstream file;
...
void file2passwd::get_file_buffer(std::streamsize file_size, char* file_buffer)
{
	std::ifstream file;
...
std::string file2passwd::convert_uchar_ptr_to_hex_string(unsigned char* result)
{
	std::stringstream ss;
